...
## Result
    Thus, the simulation of the Vehicle-to-Grid (V2G) architecture in MATLAB successfully demonstrated bidirectional power flow, with the EV charging from the grid during low demand and discharging to the grid during peak demand. The SOC variation, power flow curves, and stable grid voltage confirmed effective energy exchange and support to grid reliability.
